...
import com.jeason.news.test.MyViewPagerAdapter;
...
public class PullRefreshListViewActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPullListView.getRefreshableView().addHeaderView(view);
    ...
    private void initPageData() {
        ...
        img5.setBackgroundResource(R.drawable.ic_launcher);
        list.add(img5);

        ImageView img6 = new ImageView(this);
        img6.setBackgroundResource(R.drawable.ic_launcher);
        list.add(img6);
